...
[armorMulti(.6, 4),   health(500, 12),          swordSpeed(.75, 12), armorMulti(.2, 9),    health(500, 10),     speed(.5, 12),         fistDamage(5, 12),     health(500, 5),     bowDamage(20, 3),    bowSpeed(.5, 11),      armor(10, 14),          weapon('bow', 13),   bowSpeed(.5, 2)],
...
[swordSpeed(.75, 9),  special('pierce', 7),     health(500, 10),     special('leech', 12), health(500, 5),      clubDamage(30, 6),     special('smash', 5),   clubSpeed(.5, 14),  health(200, 5),      special('ignite', 10), special('venom', 9),    bowSpeed(.5, 10),   bowDamage(20, 12)],
