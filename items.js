...
items.powerCrystal = {
    'name': 'Power Crystal',
    'helpText': 'A crystal developed by the ancients to power their technology. It can be used it to power various devices.',
    'value': 0
};
items.amplifyingCrystal = {
    'name': 'Amplifying Crystal',
    'helpText': 'A crystal developed by the ancients which can amplify the power generated by other crystals.',
    'value': 0
};
items.batWing = {
    'name': 'Bat Wing',
